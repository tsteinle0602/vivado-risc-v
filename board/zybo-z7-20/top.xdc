...
## Reset button
set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVCMOS33} [get_ports {reset[0]}]

set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33} [get_ports txd_led]
set_property -dict {PACKAGE_PIN M15 IOSTANDARD LVCMOS33} [get_ports rxd_led]
