...
# module references:
# Rocket64b1, sdc_controller, uart
...
proc create_root_design { parentCell } {
  ...
  set txd_led [ create_bd_port -dir O -type data txd_led ]
  ...
  if { [catch {set RocketChip [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.RAM_ADDR_OFFSET_MB {512} $RocketChip
...
\
  ...
  connect_bd_intf_net -intf_net RocketChip_MEM_AXI4 [get_bd_intf_pins IO/S01_AXI] [get_bd_intf_pins RocketChip/MEM_AXI4]
  ...
  exclude_bd_addr_seg -offset 0x00000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces IO/SD/M_AXI] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM]
  exclude_bd_addr_seg -offset 0x80000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces RocketChip/MEM_AXI4] [get_bd_addr_segs RocketChip/DMA_AXI4/reg0]
